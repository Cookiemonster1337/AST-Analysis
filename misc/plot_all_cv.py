...
test_list_char = sorted([t for t in test_list if t.endswith('CV')])
...
cv_fig.write_html(
    r'W:\Projekte\#Projektvorbereitung\09-ZBT\Insitu Corrosion\Ergebnisse\operando_analysis\AST_Plots\CV' + '\\' + 'all_cv' + '.html')
